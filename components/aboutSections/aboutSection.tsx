...
const AboutSection = () => {
  return (
    ...
    <div className="about-page-common-max-width mx-auto md:pb-24 pb-20">
        <div className="flex items-center justify-between ">
            ...
            <aside className="w-fit">
                ...
                <div className="md:text-[60px] text-[43px] tracking-[-0.5px] leading-[42.68px] md:leading-[62.4px] ">
                    ...
                    <Bai_700 text="Become Impact" className="inline base-purple-text uppercase nd:w-120 "/>

                </div>

                <div className="pt-6 mt-6 md:max-w-110">
        ...
        <div className="pt-20 pb-3 grid md:grid-cols-3 gap-6">
...
{/* 
        <div className="w-full h-fit about-page-about-section-shadw  relative flex items-center justify-center overflow-hidden  aspect-ration[1023/96] " > 
