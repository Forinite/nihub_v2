  ...
  return (
      <section className="py-24">
            ...
            <div className="w-[1022px] mx-auto px-8 relative">
                ...
                <div className="base-purple-bg p-16 w-full rounded-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-20 grid grid-cols-2 gap-12">
                        <div className="w-full py-1.5">
                            ...
                            <div>
                                <Bai_700  className="uppercase text-[52px] text-white leading-[65px] tracking-[-0.5px] " text="Ready to Access Everything "/>
                                <Bai_700  className="uppercase text-[52px] text-white leading-[65px] tracking-[-0.5px] max-w-50" text=" NIHUB Has to Offer? "/>                               
                            </div>
                        ...
                        <div className="flex flex-col  justify-center gap-4">
                             {AccessPoints.map((item, index) => (
                                <div key={index} className="flex  items-center gap-4 p-5 rounded-[14px] bg-[#FFFFFF12] border border-[#FFFFFF1F]">
                                    <div>
                            ...
                            <div className="flex items-center pt-2 gap-3 text-[13px]">
                                ...
                                <LinkTemp2 text="Contact Us" href="/" className="border border-[#FFFFFF33] py-3 px-6 rounded-[10px] gap-2 text-white opacity-85 " linkIndex={1} />
                            </div>
