...
const TrainingSection = () => {
  return (
    <section className='common-section-padding px-8 common-max-width mx-auto '>
        <div className='relative md:h-32 w-full'>
            ...
            <LinkTemp2 href='/trainings' className='md:absolute bottom-0 right-0 base-purple-text text-[13px] w-fit md:mt-0 mt-4' text='View all trainings ' linkIndex={1} />
